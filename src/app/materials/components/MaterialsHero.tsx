...
// Full-width navy cover for the materials page — same language as the FAQ hero.
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-5 mx-auto py-9 sm:py-12">
        ...
        <p className="mt-3 max-w-xl text-[15px] text-[#c3c9d4] blog-rise-2">
          ჩამოტვირთე ინგლისურის სასწავლო მასალები დონეების მიხედვით — უფასოდ.
        </p>
      </div>
    </div>
  );
