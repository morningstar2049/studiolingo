...
export const positionData: TPositionData = {
  englishTeacher: {
    ...
    obligations: [
      "ონლაინ გაკვეთილების ჩატარება მოსწავლეებთან 17 წელს ზემოთ (ინდივიდუალური გაკვეთილი 1 სთ, ჯგუფური 1 სთ 30 წთ)",
    ...
    requirements: [
      ...
      "გქონდეთ ონლაინ ან ცოცხალი სწავლების გამოცდილება და იყოთ ტექნიკასთან მეგობრული",
      "გიყვარდეთ კამერის ობიექტივში გამოჩენა",
    ],
    offer: [
      "გარანტირებულ მინიმუმ სამუშაო საათებს",
      "წინასწარ შეთანხმებულ ცხრილს",
      "სამუშაო ანგარიშს ულიმიტო დრაივითა და AI ხელსაწყოებით",
      "კარიერულ განვითარებას მიდლ, სენიორ ან მენტორ მასწავლებლამდე",
      "სწავლების სისტემურ მეთოდოლოგიას",
      "გამზადებულ სასწავლო მასალებს",
      "მოწესრიგებულ შიდა ორგანიზაციულ სისტემას",
      "სრულ ადმინისტრაციულ მხარდაჭერას",
      "წინასწარ ერთ- ან ორკვირიან გადამზადებას",
      "ზრდად საგაკვეთილო საათებს",
      "საკომუნიკაციო უნარების განვითარებას",
      "კამერასთან მუშაობის გამოცდილებას",
      "სიახლეებს სწავლების მეთოდოლოგიაში",
    ],
    salary: (
      <>
        სამუშაოს ტიპი - ჰიბრიდული (გაკვეთილების ჩატარება ონლაინ),
        ცოცხალი შეკრებები (გადაღებები და გასართობი შეხვედრები)
        <br />
        <br />
        <strong className="text-lingo-green">სამუშაოს გრაფიკი:</strong> სრული
        ან არასრული (შეთანხმებით)
        <ol className="pl-5 mt-2 space-y-1 list-decimal">
          <li>
            <strong>სრული</strong> - 40 საათი კვირაში
          </li>
          <li>
            <strong>არასრული</strong> - 25-30 საათი კვირაში
          </li>
        </ol>
        <div className="mt-3 font-bold">ორივე ვარიანტისთვის:</div>
        <ul className="pl-5 mt-1 space-y-1 list-disc">
          <li>მინიმუმ 22 საათი უნდა იყოს საღამოს საათები 19:00 - 22:30.</li>
          <li>
            დარჩენილი საათები დგინდება მასწავლებელთან სკოლის ცხრილისა და
            საჭიროებებიდან გამომდინარე.
          </li>
          <li>
            საათები ასევე მოიცავს არასაგაკვეთილო სამუშაოსაც: გუნდთან კომუნიკაცია
            და შეხვედრები, პერიოდული კონტენტ გადაღება.
          </li>
        </ul>
        <br />
        ანაზღაურება დამოკიდებულია კანდიდატის კვალიფიკაციაზე, ჩვენს სკოლაში
        მოქმედებს ჯუნიორ, მიდლის და სენიორ მასწავლებლების სისტემა კანდიდატების
        გამოცდილების მიხედვით.
        <br />
        <br />
        კანდიდატებს, რომლებსაც არ აქვთ სამუშაო გამოცდილება ან შერჩევის
        მინიმალურ კრიტერიუმებს ვერ დააკმაყოფილებენ, თუმცა აქვთ ამ სფეროში
        განვითარების პოტენციალი, Studio Lingo სთავაზობს უფასო გადასამზადებელ
        კურსებს მასწავლებლების აკადემიაში. წარმატებული კურსდამთავრებულები კი
        დასაქმდებიან ჩვენს სკოლაში ჯუნიორ მასწავლებლებად. სტაჟირების შესახებ
        ...
        <br />
        <br />
        ჩვენი სასწავლო მასალების უსაფრთხოებისა და კომპანიისთვის მნიშვნელოვანია
        ექსკლუზიური თანამშრომლობა: თუ შემოგვიერთდებით, ინგლისურს ასწავლით მხოლოდ
        სტუდიო ლინგოში და არა სხვა ფორმატში.
      </>
    ),
    location: "თბილისი",
    time: "(არა)სრული",
