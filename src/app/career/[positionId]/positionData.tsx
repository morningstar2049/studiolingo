...
export const positionData: TPositionData = {
  ...
  contentCreator: {
    ...
    extraText:
      ...
      workHours: "სრული განაკვეთი , კვირაში 5 დღე ორშ-პარ (11:00-19:00 / 12:00-20:00) - კვირაში 4 დღე დისტანციური, კვირაში ერთი დღე ადგილზე მოსვლით (Stamba-ს სამუშაო სივრცე, რუსთაველის მეტროსთან)",
    requirements: [
