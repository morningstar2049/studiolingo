...
const groupOnlineDescription = (
  <div style={{ fontFeatureSettings: "normal" }}>
    <p>
      ...
      თანამოსწავლეებთან ერთად, სახლიდან გაუსვლელად. მცირე ჯგუფებში სწავლა
    ...
    <p>
      ...
      მორგებულია ნასწავლის პრაქტიკაში გამოყენებაზე, ხოლო შემაჯამებელი გაკვეთილები
      უზრუნველყოფს განვლილი მასალის განმტკიცებას. სწავლის მინიმალური პერიოდია 4
      თვე.
    </p>
    <br />
    <p>
