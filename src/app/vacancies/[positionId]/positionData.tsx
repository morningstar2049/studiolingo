...
export const positionData: TPositionData = {
  ...
  russianTeacher: {
    ...
    obligations: [
      "ონლაინ გაკვეთილების ჩატარება მოსწავლეებთან 18 წელს ზემოთ (1 გაკვეთილი 1 სთ 30 წთ, კვირაში სამუშაო დრო შეადგენს დაახლოებით 23 სთ)",
      "გუნდის წევრებთან დროული კომუნიკაცია (მაგ: მოსწავლის გაცდენის თარიღების ადმინისტრატორისთვის მიწოდება) და იშვიათად რეპორტების წერა.",
      <>
        პერიოდულად გუნდთან ერთად ონლაინ და <strong>ცოცხალ</strong> შეკრებებზე
        დასწრება.
    ...
    requirements: [
      "იყოთ მინიმუმ 22 წლის და ასწავლოთ მინიმუმ 7 ჯგუფს/ინდივიდუალურ მოსწავლეს - ანუ კვირაში ჩვენთვის გამოყოთ ფიქსირებულად ჯამში 23 საათი, რომელსაც წინასწარ თავად ადგენთ და გვითანხმებთ.",
      "იყოთ ჩვენს გუნდში მინიმუმ 6 თვით (დაინტერესებულები ვართ მხოლოდ გრძელვადიანი თანამშრომლობით)",
      "რუსულს ფლობდეთ C1 დონეზე და ქართული იყოს მშობლიური ენა",
      "ფლობდეთ ახსნისა და გადმოცემის უნარს",
      "იყოთ ენერგიული, ორგანიზებული, კომუნიკაბელური და პასუხისმგებლიანი ჩვენი გუნდის მიმართ (რაც ჩვენი გუნდის წევრისთვის აუცილებელია)",
      "გიყვარდეთ რუსულის სწავლება (ამ საქმის სიყვარულის გარეშე შეუძლებელია)",
      "გქონდეთ ონლაინ სწავლების გამოცდილება და იყოთ ტექნიკასთან მეგობრული",
    ],
    offer: [
      "ამ პროფესიაში განვითარების დიიიდ პერსპექტივას",
    ...
    salary: (
      <>
        ...
        ჯუნიორ მასწავლებლებისთვის ანაზღაურება შეადგენს{" "}
        <strong>
          თითო ინდივიდუალურ მოსწავლეზე თვეში 80 - 120 ლარს, თითო ჯგუფზე 110 -
          250 ლარს.
        </strong>{" "}
        ანაზღაურება განსხვავებულია მოსწავლეებისა და გაკვეთილების რაოდენობის
        მიხედვით.
        ...
        სენიორ მასწავლებლებისთვის ანაზღაურება შეადგენს{" "}
        <strong>
          თითო ინდივიდუალურ მოსწავლეზე თვეში 120 - 160 ლარს, თითო ჯგუფზე 150 -
          290 ლარს.
        </strong>
        <br />
        <br />
        თუკი კანდიდატი ფლობს რუსულის სწავლების მინიმუმ 1 წლიან გამოცდილებას და
