  ...
  englishTeacher: {
    ...
    salary: (
      <>
        ანაზღაურება - გამომუშავებით.{" "}
        <strong>
          თითო ინდივიდუალურ მოსწავლეზე ანაზღაურება არის 130 - 170 ლარი, თითო
          ჯგუფზე 160 - 300 ლარი.
        </strong>{" "}
        ანაზღაურება განსხვავებულია მოსწავლეებისა და გაკვეთილების რაოდენობის
        მიხედვით.
  ...
  russianTeacher: {
    ...
    salary: (
      <>
        ანაზღაურება - გამომუშავებით.{" "}
        <strong>
          თითო ინდივიდუალურ მოსწავლეზე ანაზღაურება არის 120 - 160 ლარი, თითო
          ჯგუფზე 150 - 290 ლარი.
        </strong>{" "}
        ანაზღაურება განსხვავებულია მოსწავლეებისა და გაკვეთილების რაოდენობის
        მიხედვით.
  ...
  chineseTeacher: {
    ...
    salary: (
      <>
        ანაზღაურება - გამომუშავებით.{" "}
        <strong>
          თითო ინდივიდუალურ მოსწავლეზე ანაზღაურება არის 170 - 240 ლარი, თითო
          ჯგუფზე 230 - 490 ლარი.
        </strong>{" "}
        ანაზღაურება განსხვავებულია მოსწავლეებისა და გაკვეთილების რაოდენობის
        მიხედვით.
