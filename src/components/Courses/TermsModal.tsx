...
export default function TermsModal({
  ...
  return (
    <InfoModal open={open} onClose={onClose} title="წესები და პირობები">
      <div>
        <p>
          <strong className="text-lingo-black">1.</strong> კურსების შეძენა ხდება
          ორი გზით:
        </p>
        ...
        <ol className="flex flex-col gap-1.5 pl-6 mt-2 list-decimal">
          ...
          <li>
            უპროცენტო განვადების შემთხვევაში გადახდის შეთანხმების გაფორმებიდან 14
      ...
      <div>
        <p>
          ...
          გაცდენილი ნებისმიერი გაკვეთილი ჩატარებულად ითვლება და ჩვეულებრივ იხდით
          თანხას, ხოლო მასწავლებლის მიზეზით გაცდენილში თანხას არ იხდით.
        </p>
        <p className="mt-2">
          ...
          15 წუთის შემდეგ მასწავლებელს აქვს უფლება, გაცდენილად ჩათვალოს გაკვეთილი
          და არ დაელოდოს მოსწავლეს.
        </p>
      </div>

      <div>
        <p>
          <strong className="text-lingo-black">4.</strong> აღდგენას ექვემდებარება
          მხოლოდ მასწავლებლის მიზეზით გაცდენილი გაკვეთილები.
        </p>
        <p className="mt-2">
      ...
      <div>
        <p>
          ...
          მასწავლებელი პერიოდულად ახორციელებს გაკვეთილების მონიტორინგს უშუალოდ
          დასწრებით ან გაკვეთილის ჩაწერის ფორმით ხარისხის გაუმჯობესების მიზნით.
        </p>
        <p className="mt-2">
      ...
      <p>
        ...
        სახელმწიფო დასვენების დღე და ამ დღეების გაკვეთილები ითვლება ჩატარებულად.
      </p>
      ...
      <div>
        <p>
          <strong className="text-lingo-black">12.</strong> მოსწავლე ვალდებულია,
          ონლაინ გაკვეთილებს დაესწროს ჩართული კამერით, რაც აუცილებელია გაკვეთილის
          ეფექტურად ჩასატარებლად. კამერის გამორთვა დასაშვებია იშვიათ
          გამონაკლისებში, რომლებზეც მოსწავლე მასწავლებლისგან იღებს თანხმობას.
          სისტემატიურად გამორთული კამერით გაკვეთილებზე დასწრება დაუშვებელია.
        </p>
        <p className="mt-2">
