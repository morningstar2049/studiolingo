...
export default function RegisterButton() {
  ...
  return (
    <div ref={ref} data-glass className="fixed z-40 bottom-5 left-2 sm:left-5 msgr-anim">
      <Link
        href="/register"
      ...
      >
        <PiNotePencilBold className="text-sm sm:text-xl shrink-0 text-lingo-green" />
