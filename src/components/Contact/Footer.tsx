    ...
    <>
      ...
      >
        <p>
          ...
          <p>
            <span className="font-bold underline">
              - სამ ნაწილად გადახდით მხოლოდ ჩინურის კურსებზე
            </span>
            - სწავლის დაწყებამდე იხდით მთლიანი კურსის ტარიფის მესამედს, პირველი
            თვის დასასრულს მეორე მესამედს, მეორე თვის დასასრულს - თანხის მესამე
            ნაწილს.
          </p>
          <br />
          <p>
        ...
        <p>
          ...
          დაწყება, მოსაცდელ პერიოდად გეძლევათ მაქსიმუმ 2 კვირა და შემდგომ
          გიტარდებათ იმავე რაოდენობის ინდივიდუალური გაკვეთილები 1 სთ-მდე
          ხანგრძლივობით. თუკი კურსის შუაში გამოეთიშა თქვენი ჯგუფელი კურსს,
          პაუზის გარეშე აგრძელებთ 1 სთ-მდე ხანგრძლივობის გაკვეთილებს
          ინდივიდუალურად.
        </p>
        <p>
          <strong>3.</strong> თქვენი მიზეზით გაცდენილ გაკვეთილებში ჩვეულებრივ
        ...
        <p>
          <strong>4.</strong> აღდგენას ექვემდებარება მხოლოდ მასწავლებლის მიერ
          გაცდენილი გაკვეთილები.
        </p>
        <p>
          <strong>5.</strong> კურსის გრაფიკი უნდა იყოს ფიქსირებული
          ადმინისტრატორთან შეთანხმებული და არა ცვლადი.
        </p>
        <p>
          <strong>6.</strong> Studio Lingo-ს წარმომადგენელი პერიოდულად
          ახორციელებს გაკვეთილების ვიდეო მონიტორინგს ხარისხის გაუმჯობესების
          მიზნით.
        </p>
        <p>
          <strong>7.</strong> ჩვენი სკოლა მუშაობს ყოველდღე. სკოლაში ოფიციალური
