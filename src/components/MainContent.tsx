...
function MainContent() {
  return (
    <>
      <div className="w-full h-[100dvh] relative -z-10">
        {/* <div className="bg-[#000] opacity-50 absolute w-full h-full z-10" /> */}
        <Image src="/main-img.png" alt="main" fill={true} objectFit="contain" />
        <h1 className="text-lingo-green  font-bold text-5xl absolute translate-x-[-50%] translate-y-[-50%] top-[20%] sm:top-[15%] left-[50%]">
